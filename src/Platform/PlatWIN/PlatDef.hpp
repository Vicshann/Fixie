...
static const uint MEMPAGESIZE = NCFG.MemPageSize?NCFG.MemPageSize:0x00001000;  // 4K       // ARM?
static const uint MEMGRANSIZE = NCFG.MemGranSize?NCFG.MemGranSize:0x00010000;  // 64K      // ARM?
