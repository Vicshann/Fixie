...
FUNC_WRAPPERFI(PX::exit_group, exit_group ) {return;}  // Just returns to loader
...
FUNC_WRAPPERFI(PX::lseekGD,    lseek      ) {return 0;}
FUNC_WRAPPERFI(PX::close,      close      ) {return 0;}
FUNC_WRAPPERFI(PX::access,     access     ) {return 0;}
FUNC_WRAPPERFI(PX::mkdir,      mkdir      ) {return 0;}
FUNC_WRAPPERFI(PX::readv,      readv      ) {return 0;}   // TODO
FUNC_WRAPPERFI(PX::writev,     writev     ) {return 0;}   // TODO
FUNC_WRAPPERFI(PX::ftruncate,  ftruncate  ) {return 0;}

FUNC_WRAPPERFI(PX::mkfifo,     mkfifo     ) {return 0;}
FUNC_WRAPPERFI(PX::rmdir,      rmdir      ) {return 0;}
FUNC_WRAPPERFI(PX::link,       link       ) {return 0;}
FUNC_WRAPPERFI(PX::symlink,    symlink    ) {return 0;}
FUNC_WRAPPERFI(PX::unlink,     unlink     ) {return 0;}
FUNC_WRAPPERFI(PX::rename,     rename     ) {return 0;}
FUNC_WRAPPERFI(PX::readlink,   readlink   ) {return 0;}
FUNC_WRAPPERFI(PX::stat,       stat       ) {return 0;}
FUNC_WRAPPERFI(PX::fstat,      fstat      ) {return 0;}
FUNC_WRAPPERFI(PX::fstatat,    fstatat    ) {return 0;}
FUNC_WRAPPERFI(PX::fsync,      fsync       ) {return 0;}
FUNC_WRAPPERFI(PX::fdatasync,  fdatasync   ) {return 0;}

FUNC_WRAPPERFI(PX::getdentsGD, getdents    ) {return 0;}
FUNC_WRAPPERFI(PX::openat,     openat     ) {return 0;}
FUNC_WRAPPERFI(PX::pipe2,      pipe       ) {return 0;}
FUNC_WRAPPERFI(PX::pollGD,     poll       ) {return 0;}
FUNC_WRAPPERFI(PX::dup3,       dup        ) {return 0;}

FUNC_WRAPPERFI(PX::getcwd,  getcwd   ) {return 0;}
...
FUNC_WRAPPERFI(PX::mremap,     mremap     ) {return 0;}
FUNC_WRAPPERFI(PX::mprotectex, mprotect   ) {return 0;}
FUNC_WRAPPERFI(PX::madvise,    madvise    ) {return 0;}
FUNC_WRAPPERFI(PX::msync,      msync      ) {return 0;}
FUNC_WRAPPERNI(PX::mlock,      mlock      ) {return 0;}
FUNC_WRAPPERNI(PX::munlock,    munlock    ) {return 0;}

FUNC_WRAPPERFI(PX::gettid,     gettid     ) {return 0;}
FUNC_WRAPPERFI(PX::getpid,     getpid     ) {return 0;}   
FUNC_WRAPPERFI(PX::getppid,    getppid    ) {return 0;}
FUNC_WRAPPERFI(PX::getpgrp,    getpgrp    ) {return 0;}
FUNC_WRAPPERFI(PX::getpgid,    getpgid    ) {return 0;}
FUNC_WRAPPERFI(PX::setpgid,    setpgid    ) {return 0;}

FUNC_WRAPPERFI(PX::futexGD,    futex      ) {return 0;}

FUNC_WRAPPERFI(PX::clocksleep,  clocksleep  ) {return 0;}
FUNC_WRAPPERFI(PX::nanosleep,  nanosleep  ) {return 0;}
FUNC_WRAPPERFI(PX::gettime,  gettime  ) {return 0;}
FUNC_WRAPPERNI(PX::gettimeofday,  gettimeofday  ) {return 0;}
FUNC_WRAPPERNI(PX::settimeofday,  settimeofday  ) {return 0;}

FUNC_WRAPPERNI(NTHD::spawn,       spawn       ) {return 0;}
FUNC_WRAPPERNI(NTHD::spawn_wait,       spawn_wait       ) {return 0;}
FUNC_WRAPPERNI(NTHD::thread,       thread       ) {return 0;}
FUNC_WRAPPERNI(NTHD::thread_sleep,      thread_sleep     ) {return 0;}
FUNC_WRAPPERNI(NTHD::thread_wait,       thread_wait      ) {return 0;}
FUNC_WRAPPERNI(NTHD::thread_status,   thread_status      ) {return 0;}
FUNC_WRAPPERNI(NTHD::thread_exit,       thread_exit      ) {return 0;}

FUNC_WRAPPERFI(NDBG::ptrace,  ptrace   ) {return 0;}
FUNC_WRAPPERFI(NDBG::cache_flush,  cache_flush   ) {return;} 
//---------------------------------------------------------------------------
