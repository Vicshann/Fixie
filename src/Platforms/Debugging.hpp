...
// GENERIC operations (LINUX, BSD, MAC) (ARM/X86, X32/X64)
 ...
 PT_READ_U   = 3,      //  read word in child's user structure  // PTRACE_PEEKUSR    // holds the registers and other information about the process (see <sys/user.h>)  // addr must bealigned on an int boundary
