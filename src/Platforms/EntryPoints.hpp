...
_SYSENTRY MODERN_INIT sint _scall Mod_Enter_Proc_Main(vptr ArgA, vptr ArgB, vptr ArgC) noexcept  // On Windows ArgA is PEB ptr
{
...
//--------------------------
/*_SYSENTRY MODERN_FINI sint _scall Mod_Exit_Proc_Main(void) noexcept     // Dynamic libraries only
{
...
// if (may_not_exist)may_not_exist();
